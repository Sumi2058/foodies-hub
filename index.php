...
<body class="home">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">
                         <!-- <img class="img-rounded" src="images/food-picky-logo.png" alt=""> 
                         -->
                         <h2 style="color:white">Foodies HUb</h2>
                        </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/landing.jpg">
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <h2 style="color:white">Foodies HUb</h2> </a> <span>Order Delivery &amp; Take-Out </span> </div>
